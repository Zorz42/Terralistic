...
fn test_get_resource_path(){
    ...
    //add tests with macos paths, also with a random utf-8 "folder" in path
    ...
    assert_eq!(get_resource_path(
            String::from(r"/folder/folder/folder/folder/folder/folder/MacOS/notfolder")),
            String::from(r"/folder/folder/folder/folder/folder/folder/Resources/"), "test 7 failed");
