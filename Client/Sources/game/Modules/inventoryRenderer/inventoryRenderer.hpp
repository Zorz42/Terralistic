...
struct inventoryRenderer : gfx::sceneModule<game>, networking::packetListener {
    inventoryRenderer(game* scene, networking::networkingManager* manager) : gfx::sceneModule<game>(scene), networking::packetListener(manager) {}
