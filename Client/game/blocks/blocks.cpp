...
ClientBlocks::ClientBlocks(NetworkingManager* manager, ResourcePack* resource_pack) : networking_manager(manager), resource_pack(resource_pack) {
    ...
    stateFunctions[(int)BlockType::GRASS_BLOCK] = std::vector<void (ClientBlocks::*)(unsigned short, unsigned short)>{&ClientBlocks::updateOrientationLeft, &ClientBlocks::updateOrientationRight, &ClientBlocks::updateOrientationUp};
