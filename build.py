...
if sys.platform == "darwin":
    ...
    createDir(project_path + "Output/MacOS/")
    ...
    createDir(project_path + "Build/")
    os.system(f"cd {project_path}Build/ && cmake .. && make -j$(nproc)")

    createDir(project_path + "Output/Linux/Terralistic")
    ...
    shutil.copy("/usr/lib/x86_64-linux-gnu/llibSDL2_image-2.0.so.0", project_path + "Output/Linux/Terralistic/")
    ...
    createDir(project_path + "Output/Windows/Terralistic")
