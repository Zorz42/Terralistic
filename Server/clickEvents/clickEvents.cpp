...
void grass_block_leftClickEvent(map::block* block, playerHandler::player* player) {
    block->setType(map::blockType::DIRT);
}

void air_rightClickEvent(map::block* block, playerHandler::player* player) {
...
void air_leftClickEvent(map::block* block, playerHandler::player* player) {}
