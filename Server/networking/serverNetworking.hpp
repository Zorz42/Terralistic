...
class Connection : public EventListener<ServerInventoryItemChangeEvent>, public EventListener<RecipeAvailabilityChangeEvent> {
    sf::TcpSocket* socket;
    sf::Packet master_packet;
    
    void onEvent(ServerInventoryItemChangeEvent& event) override;
