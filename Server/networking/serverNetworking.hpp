...
public:
    ServerNetworkingManager(ServerBlocks* blocks, ServerEntityManager* entity_manager, Players* players) : blocks(blocks), entity_manager(entity_manager), players(players) {}
