...
networking::registerPacketListener block_change_listener(blockChangeListener, packets::BLOCK_CHANGE), chunk_listener(chunkListener, packets::CHUNK), block_break_progress_change_listener(blockBreakProgressChangeListener, packets::BLOCK_BREAK_PROGRESS_CHANGE);
