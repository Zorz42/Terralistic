...
void swl::render(SDL_Texture* texture, SDL_Rect destination_rectangle, SDL_Rect source_rectangle, bool flipped) {
    SDL_RenderCopyEx(__swl_private::renderer, texture, &source_rectangle, &destination_rectangle, 0, nullptr, flipped ? SDL_FLIP_HORIZONTAL : SDL_FLIP_NONE);
}

void swl::render(SDL_Texture* texture, SDL_Rect destination_rectangle, bool flipped) {
    SDL_RenderCopyEx(__swl_private::renderer, texture, nullptr, &destination_rectangle, 0, nullptr, flipped ? SDL_FLIP_HORIZONTAL : SDL_FLIP_NONE);
}
void swl::render(SDL_Texture* texture, bool flipped) {
    SDL_RenderCopyEx(__swl_private::renderer, texture, nullptr, nullptr, 0, nullptr, flipped ? SDL_FLIP_HORIZONTAL : SDL_FLIP_NONE);
}
