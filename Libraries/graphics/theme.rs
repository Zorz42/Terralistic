...
pub(crate) const GFX_DEFAULT_TEXT_INPUT_COLOR: Color = GREY;
pub(crate) const GFX_DEFAULT_TEXT_INPUT_BORDER_COLOR: Color = BORDER_COLOR;
pub(crate) const GFX_DEFAULT_TEXT_INPUT_HOVER_COLOR: Color = WHITE;
pub(crate) const GFX_DEFAULT_TEXT_INPUT_HOVER_BORDER_COLOR: Color = BORDER_COLOR;
pub(crate) const GFX_DEFAULT_TEXT_INPUT_PADDING: i32 = BUTTON_PADDING;
