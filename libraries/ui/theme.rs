...
pub const BUTTON_COLOR: Color = TRANSPARENT;
pub const BUTTON_BORDER_COLOR: Color = TRANSPARENT;
pub const HOVERED_BUTTON_COLOR: Color = GREY;
pub const HOVERED_BUTTON_BORDER_COLOR: Color = BORDER_COLOR;
pub const TEXT_INPUT_COLOR: Color = BLACK.set_a(150);
pub const TEXT_INPUT_BORDER_COLOR: Color = TRANSPARENT;
pub const TEXT_INPUT_HOVER_COLOR: Color = DARK_GREY;
pub const TEXT_INPUT_HOVER_BORDER_COLOR: Color = BORDER_COLOR;
pub const TEXT_INPUT_PADDING: f32 = 2.0;
