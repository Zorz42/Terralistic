...
const fn sdl_key_to_gfx_key(key: sdl2::keyboard::Keycode) -> Option<Key> {
    match key {
        ...
        sdl2::keyboard::Keycode::Num0 => Some(Key::Num0),
        sdl2::keyboard::Keycode::Num1 => Some(Key::Num1),
        sdl2::keyboard::Keycode::Num2 => Some(Key::Num2),
        sdl2::keyboard::Keycode::Num3 => Some(Key::Num3),
        sdl2::keyboard::Keycode::Num4 => Some(Key::Num4),
        sdl2::keyboard::Keycode::Num5 => Some(Key::Num5),
        sdl2::keyboard::Keycode::Num6 => Some(Key::Num6),
        sdl2::keyboard::Keycode::Num7 => Some(Key::Num7),
        sdl2::keyboard::Keycode::Num8 => Some(Key::Num8),
        sdl2::keyboard::Keycode::Num9 => Some(Key::Num9),
